        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Job>().HasData(
                new Job
                {
                    ...
                    Province = "Santa Fe",
                    City = "Rosario",
                    DayPublicationStart = new DateTime(2025, 5, 15, 0, 0, 0, DateTimeKind.Utc),
                    DayPublicationEnd = new DateTime(2025, 5, 24, 0, 0, 0, DateTimeKind.Utc),
                },
                new Job
                {
                    Id = 2,
                    ...
                    Province = "Santa Fe",
                    City = "Rosario",
                    DayPublicationStart = new DateTime(2025, 5, 13, 0, 0, 0, DateTimeKind.Utc),
                    DayPublicationEnd = new DateTime(2025, 5, 20, 0, 0, 0, DateTimeKind.Utc),
                },
                new Job
                {
                    Id = 3,
                    ...
                    City = "La Plata",
                    DayPublicationStart = new DateTime(2025, 5, 15, 0, 0, 0, DateTimeKind.Utc),
                    DayPublicationEnd = new DateTime(2025, 5, 18, 0, 0, 0, DateTimeKind.Utc),
                },
                new Job
                {
                    Id = 4,
                    ...
                    Province = "Mendoza",
                    City = "Godoy Cruz",
                    DayPublicationStart = new DateTime(2025, 5, 17, 0, 0, 0, DateTimeKind.Utc),
                    DayPublicationEnd = new DateTime(2025, 5, 23, 0, 0, 0, DateTimeKind.Utc),
                },
                new Job
                {
                    Id = 5,
                    ...
                    City = "Rosario",
                    DayPublicationStart = new DateTime(2025, 5, 17, 0, 0, 0, DateTimeKind.Utc),
                    DayPublicationEnd = new DateTime(2025, 5, 22, 0, 0, 0, DateTimeKind.Utc),
                },
                new Job
                {
                    Id = 6,
                    ...
                    Province = "Córdoba",
                    City = "Marcos Juarez",
                    DayPublicationStart = new DateTime(2025, 5, 16, 0, 0, 0, DateTimeKind.Utc),
                    DayPublicationEnd = new DateTime(2025, 5, 20, 0, 0, 0, DateTimeKind.Utc),
                },
                new Job
                {
                    ...
                    Province = "Santa Fe",
                    City = "Firmat",
                    DayPublicationStart = new DateTime(2025, 4, 21, 0, 0, 0, DateTimeKind.Utc),
                    DayPublicationEnd = new DateTime(2025, 4, 26, 0, 0, 0, DateTimeKind.Utc),
                },
                new Job
                {
                    Id = 8,
            ...
            modelBuilder.Entity<Report>().HasData(
                ...
                {
                    Id = 1,
                    Created_At = new DateTime(2025, 5, 28, 0, 0, 0, DateTimeKind.Utc),
                ...
                {
                    Id = 2,
                    Created_At = new DateTime(2025, 5, 27, 0, 0, 0, DateTimeKind.Utc),
                ...
                {
                    Id = 3,
                    Created_At = new DateTime(2025, 5, 25, 0, 0, 0, DateTimeKind.Utc),
                    CategoryReport = CategoryReport.OffensiveContent,
                    JobId = 7,
                    ClientId = 6,
                }
            ...
            modelBuilder.Entity<Postulation>().HasData(
                new Postulation
                {
                    ...
                    JobId = 1,
                    Budget = 15000,
                    JobDay = new DateTime(2025, 5, 23, 0, 0, 0, DateTimeKind.Utc),
                ...
                new Postulation
                {
                    ...
                    JobId = 1,
                    Budget = 14000,
                    JobDay = new DateTime(2025, 5, 22, 0, 0, 0, DateTimeKind.Utc),
                ...
                new Postulation
                {
                    ...
                    JobId = 3,
                    Budget = 20000,
                    JobDay = new DateTime(2025, 5, 16, 0, 0, 0, DateTimeKind.Utc),
                    Status = PostulationStatusEnum.Success
                },
                new Postulation
                {
                    ...
                    JobId = 3,
                    Budget = 18000,
                    JobDay = new DateTime(2025, 5, 17, 0, 0, 0, DateTimeKind.Utc),
                ...
                new Postulation
                {
                    ...
                    JobId = 4,
                    Budget = 22000,
                    JobDay = new DateTime(2025, 5, 21, 0, 0, 0, DateTimeKind.Utc),
                    Status = PostulationStatusEnum.Success
                }
            );
